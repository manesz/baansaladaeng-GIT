...
<head>
    ...
    <title>Long stay contact from website Baansaladaeng.com</title>
    <style type="text/css">
        body {
...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0" class="tableContent bgBody" align="center"
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div
                                                                    ...
                                                                    <div class='contentEditable'
                                                                         style='text-align: center;'>
                                                                        <h2 style="font-size: 20px;">Long Stay
                                                                            Question.</h2>
                                                                        <br>
                                                                        <table id="content"
                                                                            ...
                                                                            <tr>
                                                                                <td width="30%">Name</td>
                                                                                <td width="70%"><?php echo empty($full_name) ? "" : $full_name; ?></td>
                                                                            </tr>
                                                                            <tr>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td width="70%"><?php echo empty($telephone) ? "" : $telephone; ?></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td width="30%">Fax</td>
                                                                                <td width="70%"><?php echo empty($fax) ? "" : $fax; ?></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td width="30%">Questions</td>
                                                                                <td width="70%"><?php echo empty($questions) ? "" : nl2br($questions); ?></td>
                                                                            </tr>
                                                                        </table>
                                                                    </div>
                                                                </div>
