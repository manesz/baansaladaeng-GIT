...
<head>
    ...
    <title>Contact from website Baansaladaeng.com</title>
    <style type="text/css">
        body {
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div
                                                                    ...
                                                                    <div class='contentEditable'
                                                                         style='text-align: center;'>
                                                                        <h2 style="font-size: 20px;">Contact
                                                                            information</h2>
                                                                        <br>
                                                                        <table id="content"
                                                                            ...
                                                                            <tr>
                                                                                <td width="30%">Name</td>
                                                                                <td width="70%"><?php echo empty($send_name) ? "" : $send_name; ?></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td width="30%">Email</td>
                                                                                <td width="70%"><?php echo empty($send_email) ? "" : $send_email; ?></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td width="30%">Message</td>
                                                                                <td width="70%"><?php echo empty($send_message) ? "" : nl2br($send_message); ?></td>
                                                                            </tr>
                                                                        </table>
                                                                    </div>
                                                                </div>
