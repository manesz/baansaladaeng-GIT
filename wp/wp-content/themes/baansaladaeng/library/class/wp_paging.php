...
class wp_paging {
    ...
    public function modify_first_number($page_nav, $current_num, $prev_next, $prev_text) {
        ...
        if ($current_num > 1) {
            ...
            if ($prev_next === true) {
                $next_prev_li = "<a class='page-numbers ui-link prev' href='" . get_pagenum_link($current_num - 1) . "'>" . $prev_text . "</a></li>\n\t";
                $page_nav = str_replace($modified[1], $next_prev_li, $page_nav);
            }
            $first_li = "<a class='page-numbers ui-link' href='" . get_pagenum_link(0) . "'>1</a></li>\n\t";
