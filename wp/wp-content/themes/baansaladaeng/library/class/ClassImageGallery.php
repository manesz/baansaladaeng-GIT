...
{
    private $wpdb;
    public $tableImageGallery = "ics_image_gallery";
    public $countValue = 0;
    ...
    {
        $sql = "
            CREATE TABLE `$this->tableImageGallery` (
    ...
    {
        if (!$this->countValue) {
            $sql = "SELECT COUNT(id) FROM $this->tableImageGallery WHERE 1 AND `publish` = 1";
    ...
    {
        $sql ="
          SELECT * FROM $this->tableImageGallery WHERE id={$sid} AND `publish` = 1
        ";
