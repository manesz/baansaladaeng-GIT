...
<!--                <h2 class="col-md-12">Select Rooms <span class="font-color-999 font-size-14">Mediterranean Suite</span> </h2>-->
                ...
                <div id="sectionRoom">
                    <?php for($i=1;$i<=3; $i++):?>
                        <div class="col-md-12 alpha bg-fafafa clearfix margin-bottom-20" style="height: 250px;">
                            <div class="col-md-4 alpha omega"><img src="libs/images/room-01.jpg" style="margin: 0px; padding: 0px; width: 100%; height: 250px; overflow: hidden;"/></div>
                            <div class="col-md-8">
                                ...
                                <div class="col-md-4 bg-ED2024" style="text-align: center; padding: 10px 0 10px 0; color: #fff; ">CHOOSE</div>
                            </div>
                        </div>
                    <?php endfor; ?>
                </div>
                <div id="sectionPayment" class="form-group">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-12 margin-bottom-10 alpha omega">
                            ...
                            <div class="col-md-9 alpha omega"><input id="formPaymentName" name="formPaymentName" type="text" class="form-control col-md-12"/></div>
                        </div>
                        <div class="col-md-12 margin-bottom-10 alpha omega">
                            <div class="col-md-3 alpha"><label for="formPaymentMiddleName">Middle Name</label></div>
                            <div class="col-md-9 alpha omega"><input id="formPaymentMiddleName" name="formPaymentMiddleName" type="text" class="form-control col-md-12"/></div>
                        </div>
                        <div class="col-md-12 margin-bottom-10 alpha omega">
                            <div class="col-md-3 alpha"><label for="formPaymentLastName">Last Name</label></div>
                            <div class="col-md-9 alpha omega"><input id="formPaymentLastName" name="formPaymentLastName" type="text" class="form-control col-md-12"/></div>
                        </div>
                        <div class="col-md-12 margin-bottom-10 alpha omega">
                            <div class="col-md-3 alpha"><label for="formPaymentDOB">Date of Birth</label></div>
                            <div class="col-md-9 alpha omega"><input id="formPaymentDOB" name="formPaymentDOB" type="text" class="form-control col-md-12"/></div>
                        </div>
                        <div class="col-md-12 margin-bottom-10 alpha omega">
                            <div class="col-md-3 alpha"><label for="formPaymentPassspotNo">Passspot No.</label></div>
                            <div class="col-md-9 alpha omega"><input id="formPaymentPassspotNo" name="formPaymentPassspotNo" type="text" class="form-control col-md-12"/></div>
                        </div>
                        <div class="col-md-12 margin-bottom-10 alpha omega">
                            <div class="col-md-3 alpha"><label for="formPaymentNationality">Nationality</label></div>
                            <div class="col-md-9 alpha omega"><input id="formPaymentNationality" name="formPaymentNationality" type="text" class="form-control col-md-12"/></div>
                        </div>
                        <div class="col-md-12 margin-bottom-10 alpha omega">
                            <div class="col-md-3 alpha"><label for="formPaymentEmail">Email</label></div>
                            <div class="col-md-9 alpha omega"><input id="formPaymentEmail" name="formPaymentEmail" type="text" class="form-control col-md-12"/></div>
                        </div>
                        <div class="col-md-12 margin-bottom-10 alpha omega">
                            <div class="col-md-3 alpha"><label for="formPaymentTime">Estimated arrival Time</label></div>
                            <div class="col-md-9 alpha omega"><input id="formPaymentTime" name="formPaymentTime" type="text" class="form-control col-md-12"/></div>
                        </div>
                        <div class="col-md-12 margin-bottom-10 alpha omega">
                            <div class="col-md-3 alpha"><label for="formPaymentTel">Tel/Mobile Number</label></div>
                            <div class="col-md-9 alpha omega"><input id="formPaymentTel" name="formPaymentTel" type="text" class="form-control col-md-12"/></div>
                        </div>
                        <div class="col-md-12 margin-bottom-10 alpha omega">
                            <div class="col-md-3 alpha"><label for="formPaymentPersonNo">No. of Person</label></div>
                            <div class="col-md-9 alpha omega"><input id="formPaymentPersonNo" name="formPaymentPersonNo" type="text" class="form-control col-md-12"/></div>
                        </div>
                        <div class="col-md-12 margin-bottom-10 alpha omega">
                            <div class="col-md-3 alpha"><label for=""></label></div>
                            <div class="col-md-9 alpha omega"><input id="formPaymentPickup" name="formPaymentPickup" type="checkbox" style="margin-right: 20px;"/>Need Airport Pickup (THB 1,200 one way)</div>
                        </div>
                        <div class="col-md-12 margin-bottom-10 alpha omega">
                ...
                <div id="sectionConfirm">
                    ...
                    <div class="col-md-12 margin-bottom-10 alpha omega">
                        ...
                        <div class="col-md-9 alpha omega">
                            <input type="text" id="formPaymentCreditCardHolder" name="formPaymentCreditCardHolder" class="form-control col-md-12"/>
                        </div>
                    </div>
                    <div class="col-md-12 margin-bottom-10 alpha omega">
                        <div class="col-md-3 alpha"><label for="formPaymentCreditCardNo">Card No.</label></div>
                        <div class="col-md-9 alpha omega">
                            <input type="text" id="formPaymentCreditCardNo" name="formPaymentCreditCardNo" class="form-control col-md-12"/>
                        </div>
                    </div>
                    <div class="col-md-12 margin-bottom-10 alpha omega">
                        <div class="col-md-3 alpha"><label for="formPaymentCreditCard3Ditgit">3-Digit ID#</label></div>
                        <div class="col-md-9 alpha omega">
                            <input type="text" id="formPaymentCreditCard3Ditgit" name="formPaymentCreditCard3Ditgit" class="form-control col-md-12"/>
                    ...
                    <div class="col-md-12 margin-bottom-10 alpha omega">
                        ...
                        <div class="col-md-9 alpha omega">
                            <input type="text" id="formPaymentCreditCardExpiry" name="formPaymentCreditCardExpiry" class="form-control col-md-12"/>
                        </div>
                    </div>
                    <div class="col-md-12 margin-bottom-10 alpha omega">
                        <div class="col-md-12 alpha omega">
                            <bottom type="submit" id="formPaymentCreditCardExpiry" name="formPaymentCreditCardExpiry" class="btn btn-success form-control col-md-12" value="SUBMIT"/>
                        </div>
                    </div>
                </div>
            ...
            <div class="text-center col-md-3 portfolio-work-grid wow fadeInLeft margin-bottom-20" data-wow-delay="0.4s">
                <h4 class="bg-ED2024" style="background: #ED2024; padding: 15px 0 15px 0; color: #fff; margin: 0px;">THE ORDER</h4>
